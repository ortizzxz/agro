...
import PageFarmFilterHeader from "./components/PageFarmFilterHeader";
interface FarmKPI {
...
export default function HomePage() {
  ...
  useEffect(() => {
    ...
    const timer = setTimeout(() => {
      const filter = (data: any[]) =>
        selectedFarm === "all"
          ? data
          : data.filter((d) => d.farmId === selectedFarm);
  ...
  return (
    <div className="space-y-3 px-2">
      <PageFarmFilterHeader title="Dashboard" onChange={setSelectedFarm} />
      {/* kpi*/}
...
const allAlerts = [
  {
    farmId: "north",
    type: "Livestock",
    item: "Batch CH-2024-03",
    alert: "Mortality above average",
  },
  {
    farmId: "greenhouse",
    type: "Crop",
